...
int bc2d_copy_forward_stride(char * src, char * dest, size_t itemsize, size_t Nr, size_t Nc, size_t Br, size_t Bc, size_t Pr, size_t Pc, size_t pr, size_t pc, size_t stride);
int bc2d_copy_backward_stride(char * src, char * dest, size_t itemsize, size_t Nr, size_t Nc, size_t Br, size_t Bc, size_t Pr, size_t Pc, size_t pr, size_t pc, size_t stride);
